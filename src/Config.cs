...
namespace PlayerCorpse
{
    public class Config
    {
        ...
        public Part<bool> CreateDeathSoul { get; set; } = new Part<bool>(true, "[true, false]");
        ...
        public Part<int> MaxDeathContentSavedPerPlayer { get; set; } = new Part<int>(10, "WIP! [0-100] (0 - disabled)");
        ...
        public Part<string> WaypointIcon { get; set; } = new Part<string>("circle", "[circle, bee, cave, home, ladder, pick, rocks, ruins, spiral, star1, star2, trader, vessel]");
